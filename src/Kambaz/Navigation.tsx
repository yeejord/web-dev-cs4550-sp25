...
export default function KambazNavigation() {
  return (
    <div id="wd-kambaz-navigation">
      ...
      <Link to="/Kambaz/Courses/:cid/" id="wd-course-link">Courses</Link><br/>
      <Link to="/Kambaz/Calendar" id="wd-calendar-link">Calendar</Link><br/>
      <Link to="/Kambaz/Inbox" id="wd-inbox-link">Inbox</Link><br/>
      <Link to="/Kambaz/History" id="wd-history-link">History</Link><br/>
      <Link to="/Kambaz/Studio" id="wd-studio-link">Studio</Link><br/>
      <Link to="/Kambaz/Help" id="wd-help-link">Help</Link><br/>
