    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                uses headings to introduce topics such as HTML Documents, HTML Tags, Heading Tags,
                etc. HTML heading tags can be used to format plain text so that it renders in a browser 
            ...
            <div id="wd-p-tag">
                ...
                <p id ="wd-p-2"> 
                    This is the first paragraph. The paragraph tag is used to format vertical gaps between long pieces of 
                    text like this one.
                </p>
                <p id ="wd-p-3"> 
                    This is the second paragraph. Even though there is a deliberate white gap between the paragraph above 
                    and this paragraph, by default browsers render them as one contiguous piece of text as shown here on the right.
                </p>
                <p id ="wd-p-4"> 
            ...
            <div id="wd-lists">
                ...
                <h5>Ordered List Tag</h5>
                    ...
                    <ol id ="wd-your-favorite-recipe">
                        <li>preheat the oven to 375 degrees farenheit</li>
                        <li>combine the flour, baking soda, and salt</li>
                        <li>beat the butter, granulated sugar, brown sugar, and vanilla extract together</li>
                        <li>add the eggs to the butter and sugar mixture</li>
                        <li>gradually beat in the flour mixture</li>
                        <li>stir in the chocolate chips</li>
                        <li>place tablespoon size balls of dough onto the tray</li>
                ...
                <h5>Unordered List Tag</h5>
                    ...
                    <ul id="wd-your-books">
                        ...
                        <li>Elantris</li>
                        <li>A Court of Thrones and Roses</li>
                        <li>Harry Potter</li>
                    </ul>
            ...
            <div id="wd-forms">
                ...
                <h4>Anchor tag</h4>
                    ...
                    Please <a href="https://github.com/yeejord/web-dev-cs4550-sp25.git" id="wd-github">click here</a> to access my github code repository <b/>
            </div>
